...
test.describe("Authentication Flow", () => {
	...
	test("should display login form when accessing protected route without authentication", async ({
		...
		await expect(
			testHelper.page.locator('[data-test-id="username-input"]'),
		).toBeVisible();
		await expect(
			testHelper.page.locator('[data-test-id="password-input"]'),
		).toBeVisible();
		await expect(
			testHelper.page.locator('[data-test-id="login-button"]'),
		).toBeVisible();
		await expect(
			testHelper.page.locator('[data-test-id="login-form"]'),
		).toBeVisible();
	});
	...
	test("should successfully login with valid credentials", async ({
		...
		await expect(
			testHelper.page.locator('[data-test-id="dashboard-container"]'),
		).toBeVisible();
	...
	test("should show loading state during login", async ({
		...
		await testHelper.page.fill(
			'[data-test-id="username-input"]',
			testData.users.user1.username,
		);
		await testHelper.page.fill(
			'[data-test-id="password-input"]',
			testData.users.user1.password,
		);
		...
		await expect(
			testHelper.page.locator('[data-test-id="login-loader"]'),
