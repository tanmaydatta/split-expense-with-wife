...
describe("Budget Handlers", () => {
    ...
    describe("handleBudgetMonthly", () => {
        it("should return monthly budget totals with average calculations", async () => {
            ...
            const month1Budget = json.monthlyBudgets.find((b) => b.month === monthNames[month1.getMonth()] &&
                b.year === month1.getFullYear());
            const month2Budget = json.monthlyBudgets.find((b) => b.month === monthNames[month2.getMonth()] &&
                b.year === month2.getFullYear());
            const month3Budget = json.monthlyBudgets.find((b) => b.month === monthNames[month3.getMonth()] &&
                b.year === month3.getFullYear());
            expect(month1Budget).toBeTruthy();
            expect(month1Budget.amounts[0].amount).toBe(500);
            expect(month2Budget).toBeTruthy();
            expect(month2Budget.amounts[0].amount).toBe(600);
            expect(month3Budget).toBeTruthy();
            expect(month3Budget.amounts[0].amount).toBe(400);
            ...
            const oneMonthAverage = json.averageMonthlySpend.find((avg) => avg.periodMonths === 1);
            ...
            const twoMonthAverage = json.averageMonthlySpend.find((avg) => avg.periodMonths === 2);
            ...
            const threeMonthAverage = json.averageMonthlySpend.find((avg) => avg.periodMonths === 3);
        ...
        it("should handle empty budget data and return default averages", async () => {
            ...
            json.monthlyBudgets.forEach((budget) => {
            ...
            const oneMonthPeriod = json.averageMonthlySpend.find((avg) => avg.periodMonths === 1);
        ...
        it("should calculate rolling averages correctly for different time periods", async () => {
            ...
            const getRecentDate = (monthsBack) => {
            ...
            const sixMonthAverage = json.averageMonthlySpend.find((avg) => avg.periodMonths === 6);
            if (sixMonthAverage) {
                ...
                expect(sixMonthAverage.averages[0].averageMonthlySpend).toBe(sixMonthAverage.averages[0].totalSpend /
        ...
        it("should handle mixed positive and negative amounts correctly", async () => {
            ...
            const month3Budget = json.monthlyBudgets.find((b) => b.month === monthNames[month3.getMonth()] &&
                b.year === month3.getFullYear());
            const month4Budget = json.monthlyBudgets.find((b) => b.month === monthNames[month4.getMonth()] &&
                b.year === month4.getFullYear());
            // Month 1: -250 - 150 = 400 USD expenses (shown as positive)
            expect(month1Budget).toBeTruthy();
            const month1USD = month1Budget.amounts.find((a) => a.currency === "USD");
            expect(month1USD?.amount).toBe(400);
            // Month 2: -300 - 200 = 500 USD, 75 GBP expenses (shown as positive)
            expect(month2Budget).toBeTruthy();
            const month2USD = month2Budget.amounts.find((a) => a.currency === "USD");
            const month2GBP = month2Budget.amounts.find((a) => a.currency === "GBP");
            expect(month2USD?.amount).toBe(500);
            expect(month2GBP?.amount).toBe(75);
            // Month 3: No expenses, so no entries should exist
            expect(month3Budget).toBeTruthy();
            const month3USD = month3Budget.amounts.find((a) => a.currency === "USD");
            const month3GBP = month3Budget.amounts.find((a) => a.currency === "GBP");
            ...
            const month4USD = month4Budget.amounts.find((a) => a.currency === "USD");
            const month4GBP = month4Budget.amounts.find((a) => a.currency === "GBP");
            ...
            const oneMonthUSD = oneMonthAverage.averages.find((a) => a.currency === "USD");
            const oneMonthGBP = oneMonthAverage.averages.find((a) => a.currency === "GBP");
            ...
            const fourMonthAverage = json.averageMonthlySpend.find((avg) => avg.periodMonths === 4);
            if (fourMonthAverage) {
        ...
        it("should handle currencies with zero spending correctly", async () => {
            ...
            const testMonthBudget = json.monthlyBudgets.find((b) => b.month === monthNames[testMonth.getMonth()] &&
            ...
            const testUSD = testMonthBudget.amounts.find((a) => a.currency === "USD");
            const testGBP = testMonthBudget.amounts.find((a) => a.currency === "GBP");
            ...
            const oneMonthAverage = json.averageMonthlySpend.find((avg) => avg.periodMonths === 1);
            expect(oneMonthAverage).toBeTruthy();
            const avgUSD = oneMonthAverage.averages.find((a) => a.currency === "USD");
            const avgGBP = oneMonthAverage.averages.find((a) => a.currency === "GBP");
            ...
            if (maxPeriod >= 12) {
                ...
                const longPeriodAverage = json.averageMonthlySpend.find((avg) => avg.periodMonths === maxPeriod);
