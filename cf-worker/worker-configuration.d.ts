/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env -e prod` (hash: a4f7104de5af5f9fa7db1220f871cb68)
// Runtime types generated with workerd@1.20250712.0 2024-09-23 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		GROUP_IDS: "1";
		BASE_URL: "http://localhost:8787/auth" | "https://splitexpense.tanmaydatta.workers.dev/auth" | "https://splitexpense-dev.tanmaydatta.workers.dev/auth";
		AUTH_TRUSTED_ORIGINS: ["http://localhost:8787","http://localhost:3000"] | ["https://splitexpense.tanmaydatta.workers.dev"] | ["https://splitexpense-dev.tanmaydatta.workers.dev"];
		AUTH_PIN: string;
		DSN: string;
		DSN_D1: string;
		DSN_POSTGRES: string;
