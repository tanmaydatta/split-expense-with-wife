 ...
 * Creates users, groups, and sessions tables if they don't exist
 */
export async function setupDatabase(env: Env): Promise<void> {
  // Create tables if they don't exist (single line statements)
 ...
 * Removes all data from users, groups, and sessions tables
 */
